...
//                 <img
//                   src="https://cdn.prod.website-files.com/65a823bc36fc91ffafdc2c49/674dee800b9b269a8a77e45b_AdobeStock_469043336.jpg"
//                   alt="Professional babysitter playing with baby"
...
//               <div className="relative overflow-hidden rounded-2xl shadow-lg transition-transform duration-300 group-hover:scale-105">
//                 <img
//                   src="https://blog.urbansitter.com/wp-content/uploads/2023/04/senior-caregiver-companion-care-1024x536.png"
//                   alt="Caregiver companion talking with elderly person"
//                   className="w-full h-80 object-cover"
//                 />
//                 <div className="absolute inset-0 bg-gradient-to-t from-black/60 to-transparent" />
//                 <div className="absolute bottom-0 left-0 right-0 p-6 text-white">
...
//                   alt="Nurse providing in-home care for patient"
//                   className="w-full h-80 object-cover"
//                 />
//                 <div className="absolute inset-0 bg-gradient-to-t from-black/60 to-transparent" />
//                 <div className="absolute bottom-0 left-0 right-0 p-6 text-white">
...
//             Join us in making caregiving easier and more trustworthy for families everywhere.
//           </p>
//           <div className="flex items-center justify-center gap-2 text-[#ff0099]">
//             <Home className="w-6 h-6" />
//             <span className="font-medium">True Care — Care from the Heart</span>
//           </div>
//         </div>
//       </div>
//     </section>
